      ...
      <form className={classes.form} action={onSubmit}>
        <div className={classes.formItmes}>
          <p className={classes.formItem}>
            <label className={classes.label} htmlFor="guestName">이름</label>
            <input
            ...
            />
            {erros.guestName && <span className={classes.error}>{erros.guestName}</span>}
          </p>

          <p className={classes.formItem}>
            <label className={classes.label} htmlFor="password">비밀번호</label>
            <input
              className={classes.textInput}
              type="password"
              id="password"
            ...
            />
            {erros.password && <span className={classes.error}>{erros.password}</span>}
          </p>

          <p className={classes.formItem}>
            <label className={classes.label} htmlFor="contents">방명록</label>
            <textarea
            ...
            />
            {erros.contents && <span className={classes.error}>{erros.contents}</span>}
          </p>
        </div>
