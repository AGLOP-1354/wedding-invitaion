...
const ShareKakao = () => {
  ...
  const handleKakaoShare = () => {
    window.Kakao.Share.sendDefault({
      ...
      content: {
        title: '김태현 & 김기현 결혼합니다.',
        description:
          '2024.10.12(토) 오후 17:00 고려대학교 교우회관 1층 고려스퀘어홀',
        imageUrl:
          'https://link-dropper-bucket.s3.ap-northeast-2.amazonaws.com/gallery1.jpeg',
        link: {
  ...
  return (
    <button className={classes.ShareKakao} onClick={handleKakaoShareCustom}>
      <Image
